...
LRESULT CALLBACK sub_1DF3(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        if (!sub_3C20(hWnd)) {
            MessageBox(hWnd, "Limite de instancias alcanzado!", "Screen Mate", MB_ICONHAND | MB_OK);
            return -1;
        }
#ifdef _WIN32
        ...
        if (!sub_42F3(var_2)) {
            MessageBox(hWnd, "���������s�����Ă��܂�", "Screen Mate", MB_ICONHAND | MB_OK);
    ...
    case WM_USER + 1:
        ...
        case 0x205:
            ...
            *(HMENU *)var_122 = CreatePopupMenu();
            AppendMenu(*(HMENU *)var_122, 0U, 101U, "Screen Mate�̐ݒ�...");
            AppendMenu(*(HMENU *)var_122, 0U, IDCANCEL, "Screen Mate�̏I��");
